...
class IncomeCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create income_category" do
    assert_difference('IncomeCategory.count') do
      post :create, income_category: { ancestry: @income_category.ancestry, name: @income_category.name, pinyin: @income_category.pinyin }
    end
  ...
  test "should update income_category" do
    patch :update, id: @income_category, income_category: { ancestry: @income_category.ancestry, name: @income_category.name, pinyin: @income_category.pinyin }
    assert_redirected_to income_category_path(assigns(:income_category))
  end
